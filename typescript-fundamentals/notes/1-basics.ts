 ...
 */
// let z; //wildcard type. Any can take on any type like normal js. If you're gonna use this, make sure you wanna allow anything.
// z = 41;
 ...
 */
// let aa: number[] = []; //no type on empty array results in never. Never is TS bottom type. Adding a type when initializing an array make they array result in that type.
// aa.push(33);
 ...
 */
//  let aa: any[] = []; // we can always add any to lose type restrictions up.
...
// bb.push(1,2,3,4,5,6,) //no type safety with push
...
// we can only access things that are for sure going to be there.
/**
